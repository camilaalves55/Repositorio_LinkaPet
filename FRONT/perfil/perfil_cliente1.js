    ...
    try {
        ...
        if (clienteData.success) {
            ...
            document.getElementById('foto_perfil').addEventListener('click', () => {
                document.getElementById('previewImg').src = document.getElementById('imagem_perfil').src;
            ...
            document.getElementById('okBtn').addEventListener('click', async () => {
                ...
                try {
                    ...
                    if (result.success) {
                     ...
                     document.getElementById('previewImg').src = `http://localhost:3005/upload/${fotoPerfil}?t=${new Date().getTime()}`;
                        Swal.fire({
                            title: 'Sucesso!',
